...
def _onglet_ma_treso():
    ...
    with col_d:
        ...
        st.markdown(
            """
            <div style="background:#111B2C;border:1px solid #1E2A3D;border-radius:16px;padding:16px 18px;margin-top:28px;height:152px;box-sizing:border-box;">
        ...
        st.markdown(
            ...
            "padding:16px 18px;margin-top:28px;height:385px;box-sizing:border-box;\">"
