...
def _onglet_ma_treso():
    ...
    st.markdown(
        ...
        ".st-key-mt_hyp{background:#111B2C;border:1px solid #1E2A3D;border-radius:16px;padding:16px 18px;margin-top:20px;height:400px !important;box-sizing:border-box;}"
        ...
        ".st-key-mt_comptes{background:#111B2C;border:1px solid #1E2A3D;border-radius:16px;padding:14px 18px;height:100px !important;box-sizing:border-box;}"
